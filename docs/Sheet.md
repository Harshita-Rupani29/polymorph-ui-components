...
| `--sheet-header-border-bottom`          | `1px solid currentColor`         | border-bottom    | Bottom border of the header, visually separating it from the content area.                                                                                                           |
...
| `--sheet-footer-border-top`             | `1px solid currentColor`         | border-top       | Top border of the footer, visually separating it from the content area.                                                                                                              |
