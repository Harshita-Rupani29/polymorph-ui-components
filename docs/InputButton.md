...
| `--input-button-box-shadow`             | `0px 1px 8px currentColor`                           | box-shadow                      | Box shadow of the input-button row.                                         |
...
| `--input-button-left-height`                  | `54px`                                               | --button-height                 | Height of the left button.                                                  |
| `--input-button-left-padding`                 | `-`                                                  | --button-padding                | Padding inside the left button.                                             |
...
| `--input-button-right-height`                 | `54px`                                               | --button-height                 | Height of the right button.                                                 |
| `--input-button-right-padding`                | `-`                                                  | --button-padding                | Padding inside the right button.                                            |
| `--input-button-right-border-radius`          | `0px 4px 4px 0px`                                    | --button-border-radius          | Corner rounding of the right button.                                        |
