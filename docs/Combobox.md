...
| `--combobox-option-hover-background`           | `transparent`                                                       | background       | Background color of an option on hover or when highlighted via keyboard.       |
...
| `--combobox-option-selected-hover-background`  | `var(--combobox-option-selected-background, transparent)`           | background       | Background color of the selected option when also hovered/highlighted.         |
