...
<style>
  ...
  .command-menu-dialog {
    ...
    overflow: hidden;
    border: var(--command-menu-border, 1px solid currentColor);
  }
  ...
  .command-menu-search-icon {
    ...
    color: var(--command-menu-search-icon-color, currentColor);
    flex-shrink: 0;
  }
  ...
  .command-menu-input {
    ...
    color: var(--command-menu-input-color, currentColor);
    caret-color: var(--command-menu-input-caret-color, currentColor);
  }

  .command-menu-input::placeholder {
    color: var(--command-menu-input-placeholder-color, currentColor);
  }
  ...
  .command-menu-empty {
    ...
    text-align: center;
    color: var(--command-menu-empty-color, currentColor);
  ...
  .command-menu-group-heading {
    ...
    color: var(--command-menu-group-heading-color, currentColor);
  ...
  .command-menu-item {
    ...
    color: var(--command-menu-item-color, currentColor);
