...
<style>
  ...
  .context-menu-item {
    ...
    cursor: pointer;
    color: var(--context-menu-item-color, currentColor);
  ...
  .context-menu-item-danger {
    color: var(--context-menu-item-danger-color, currentColor);
  }
  ...
  .context-menu-item-shortcut {
    color: var(--context-menu-item-shortcut-color, currentColor);
