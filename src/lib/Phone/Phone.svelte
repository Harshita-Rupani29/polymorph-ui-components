...
<div class="phone-wrapper {classes ?? ''}" data-pw={testId}>
...
<style>
  ...
  .home-bar {
    ...
    background: var(--phone-home-bar-color, currentColor);
  ...
  .home-button {
    ...
    border-radius: 50%;
    border: 2px solid var(--phone-home-button-border-color, currentColor);
